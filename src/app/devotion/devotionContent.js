import styles from "./devotionContent.module.css";
  ...
  return (
    <>
      <div className={styles.container}>
        ...
        <a href="#titleEN1" className={styles.linkTo}>
          <Image
            width={28}
            height={28}
            className={styles.arrowCircleRightIcon}
        ...
        <div className={styles.text2}>
          This verse confirms the sufficiency of God&apos;s love in Christ. As
          if Paul wanted to say that in this life, all we need is God&apos;s
          love which is always sufficient. Note that the things Paul lists above
          are not small or trivial things. However, no matter how big it is, it
          will not be able to destroy the fellowship of believers in God&apos;s
          love.
        </div>
        ...
        <div className={styles.text2}>
          Unfortunately, sinful humans are often more interested in pursuing
          other certainties that are only temporary. We worry about this life,
          about governments or authorities that are not conducive to
          Christianity, about our health, studies, work, the future, and so on.
        </div>

        <div className={styles.text2}>
          Do we have a deep concern about the depth of our understanding of
          God&apos;s love? Paul prayed for the Ephesians that they “may have the
          ...
          (Ephesians 3:18). He did not pray that the Ephesian congregation would
          become successful and influential people, respected and taken into
          account by this world, who were not ashamed of Christianity. Not that!
        </div>

        <div className={styles.text2}>
          Why is understanding these various dimensions of God&apos;s love so
          important? Matthew Henry explains in his commentary:
        ...
        <div className={styles.text2}>
          God&apos;s love encompasses all. There is nothing that God&apos;s love
          cannot reach. Because of this, Paul longed for the congregation he
          served to know the abundance of this dimension of love, so that their
          lives would not only be assured, but also in abundance.
        </div>

        <div className={styles.text2}>
          Calvin even believed that every believer should have assurance of
          salvation. However, this does not mean that this assurance does not
          need room to grow. Elsewhere, Calvin teaches the dialectic
          (investigating) between the certainty and imperfection of our faith:
          <div className={styles.quotes} style={{ marginTop: "22px" }}>
            <em>
              {" "}
              Surely, while we teach that faith ought to be certain and assured,
        ...
        <div className={styles.text2}>
          Realistically, even true certainty will not be immune to uncertainty.
          So, there is always room for believers to continue to grow towards
          this assurance of grace. This growth is possible because of the
          sufficiency of God&apos;s mercy. Our part is to continue to hope and
        ...
        <div>
          ...
          <div className={styles.text3}>
            1. Do you have confidence in the sufficiency of God&apos;s love in
            Christ?
          </div>
  ...
  return (
    <>
      <div className={styles.container}>
        ...
        <div className={styles.text2}>
          This verse teaches that our calling and election are not something
          static, but can continue to grow. Yes, it can become more and more
          sure. At first glance we might feel that this contradicts the view
          that God has elected us in eternity and that this cannot possibly
          change. At least, that is what we are taught in the reformed
        ...
        <div className={styles.text2}>
          The connection is that this assurance of divine grace is not something
          that is static. Regarding this verse (2 Peter 1:10), Matthew Henry
          explains:
          <div className={styles.quotes} style={{ marginTop: "22px" }}>
            <em>
              It requires a great deal of diligence and labour to make sure our
        ...
        <div className={styles.text2}>
          A truly elected person has the responsibility to confirm his calling
          and election.
        </div>
        ...
        <div>
          ...
          <div className={styles.text3}>
            1. Do you experience that your calling and choice are becoming more
            confirmed?
          </div>

          <div className={styles.text3}>
            2. Can you share from your life experience, how you try to
            strengthen your faith with Christian virtues?
          </div>

          <div className={styles.text3}>
            3. What often prevents the assurance of grace from growing in your
